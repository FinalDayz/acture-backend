const { createUser, getUserById, getUsers, updateUsers, deleteUser, login, register, getInactiveUsers, activateUser, changeRole, checkLogin, changePassword } = require("./user.controller");
